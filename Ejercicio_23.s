...
.data
    ...
    outfmt:         .asciz "Minimum element is: %ld\n"
    scanfmt:        .asciz "%ld"
...
input_loop:
    cmp     x19, x21
    b.ge    find_min            // If counter >= size, find minimum
...
min_loop:
    ...
    cmp     x23, x22
    b.ge    next_iter            // If current >= min, continue
    mov     x22, x23             // Update min if current < min
